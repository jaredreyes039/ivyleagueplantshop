...
export default function BlogPost2(){
    ...
    return(
        <>
            <h1>{data[0].BlogPost2.Header}</h1>
            <Link to = '/Blog'><button>Back to Blog</button></Link>
            <img src = {data[0].BlogPost2.Image}></img>
            <hr></hr>
            <div class = 'row'>
            <img className='postImg' src = {data[0].BlogPost2.AuthorAvatar}></img>
            <div class = 'postData'>
                <h2>{data[0].BlogPost2.Author}</h2>
                <h3>{data[0].BlogPost2.Date}</h3>
                <h3>{data[0].BlogPost2.AuthorMotto}</h3>
                <h3 className='tags'>{data[0].BlogPost2.Tags}</h3>
            </div>
            </div>
            <hr></hr>
            <div class = 'postArticle'>
            <h2>{data[0].BlogPost2.Desc}</h2>
            <article>
...
Vestibulum ac ligula cursus, rutrum ipsum nec, ultricies elit. Sed venenatis arcu diam, vitae ultricies est vestibulum et. Etiam scelerisque volutpat turpis, non sodales metus sagittis vel. Donec in luctus velit. Ut cursus augue ante. Donec in lacus enim. Morbi nec turpis consequat, consequat odio quis, semper eros. Sed feugiat nisl nec ante ullamcorper viverra.
            ...
            <h2>Pure Evil in the Flesh!</h2>
            <img src = 'https://thumbs.dreamstime.com/b/succulent-plants-close-up-108491765.jpg'></img>
